        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                <div class="row no-gutters justify-content-between">
                    ...
                    <div class="property-address">44, Juhu Scheme, Delhi 400058</div>
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                ...
                <div class="detail-container">
                    ...
                    <div class="property-address">Police Beat, Sainath Complex, Besides, SV Rd, Delhi - 400066</div>
                    <div class="property-gender">
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                ...
                <div class="detail-container">
                    ...
                    <div class="property-address">Plot no.258/D4, Gorai no.2, Borivali West, Delhi 400092</div>
                    <div class="property-gender">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <button class="btn btn-outline-dark" onclick=" <?php $_SESSION['boys']='boys'?>">
                            <i class="fas fa-mars"></i>Male
                           

                        </button>
                            
                        <button class="btn btn-outline-dark" onclick="<?php $_SESSION['girls']='girls'?>">
