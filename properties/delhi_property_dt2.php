...
<head>
    ...
    <title>Sweet Homes | PG Life</title>
...
<body>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img2.webp" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img4.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img5.jpg" alt="slide">
            </div>
        </div>
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            ...
            <div class="testimonial-name">- Vikram Tomer</div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/man.png">
            ...
            <div class="testimonial-name">- Tushar Verma</div>
        </div>
    </div>
