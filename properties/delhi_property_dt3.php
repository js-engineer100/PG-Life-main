...
<head>
    ...
    <title>PG for Girls Pandav Nagar | PG Life</title>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list.html">Delhi</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">
                PG for Girls Pandav Nagar
            </li>
        </ol>
    </nav>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img6.jpeg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img7.jpeg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img8.jpeg" alt="slide">
            </div>
        </div>
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/woman.png">
            </div>
            ...
            <div class="testimonial-name">- Tanu </div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/woman.png">
            ...
            <div class="testimonial-name">- Tina</div>
        </div>
    </div>
