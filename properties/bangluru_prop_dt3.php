...
<head>
    ...
    <title>The Girls PG | PG Life</title>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list.html">Bangluru</a>
            </li>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img15.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img16.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img17.jpg" alt="slide">
            </div>
        </div>
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            ...
            <div class="testimonial-name">- Karen </div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/woman.png">
            ...
            <div class="testimonial-name">- Lisa </div>
        </div>
    </div>
