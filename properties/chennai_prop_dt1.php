...
<head>
    ...
    <title>Anna Paying Guest | PG Life</title>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img20.jpeg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img21.webp" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img22.webp" alt="slide">
            </div>
        </div>
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/user.png">
            </div>
            ...
            <div class="testimonial-name">- Tushar </div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/user.png">
            ...
            <div class="testimonial-name">- Prashant </div>
        </div>
    </div>
